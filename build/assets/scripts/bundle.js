...
!function (e) {
  ...
  !function (t, n) {
    ...
    function s(e, t) {
      ...
      for (var o, s, a, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) {
        if ((o = e[d]) || 0 === o) if ("object" === ye.type(o)) ye.merge(p, o.nodeType ? [o] : o);else if (Je.test(o)) {
          for (s = s || f.appendChild(t.createElement("div")), a = (Ye.exec(o) || ["", ""])[1].toLowerCase(), u = Ge[a] || Ge._default, s.innerHTML = u[1] + ye.htmlPrefilter(o) + u[2], c = u[0]; c--;) {
            s = s.lastChild;
          }ye.merge(p, s.childNodes), (s = f.firstChild).textContent = "";
        } else p.push(t.createTextNode(o));
      }for (f.textContent = "", d = 0; o = p[d++];) {
        if (r && ye.inArray(o, r) > -1) i && i.push(o);else if (l = ye.contains(o.ownerDocument, o), s = T(f.appendChild(o), "script"), l && C(s), n) for (c = 0; o = s[c++];) {
      ...
      var r,
          ...
          o,
          s,
          a = e.style;return (n = n || lt(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || ye.contains(e.ownerDocument, e) || (s = ye.style(e, t)), !me.pixelMarginRight() && ut.test(s) && at.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o)), void 0 !== s ? s + "" : s;
    }function P(e, t) {
      ...
      var o,
        ...
        "margin" === n && (s += ye.css(e, n + _e[o], !0, i)), r ? ("content" === n && (s -= ye.css(e, "padding" + _e[o], !0, i)), "margin" !== n && (s -= ye.css(e, "border" + _e[o] + "Width", !0, i))) : (s += ye.css(e, "padding" + _e[o], !0, i), "padding" !== n && (s += ye.css(e, "border" + _e[o] + "Width", !0, i)));
      }return s;
    }function $(e, t, n) {
      var r,
          i = lt(e),
          o = F(e, t, i),
          s = "border-box" === ye.css(e, "boxSizing", !1, i);return ut.test(o) ? o : (r = s && (me.boxSizingReliable() || o === e.style[t]), "auto" === o && (o = e["offset" + t[0].toUpperCase() + t.slice(1)]), (o = parseFloat(o) || 0) + W(e, t, n || (s ? "border" : "content"), r, i) + "px");
      ...
      var r,
        ...
        delete u.elem;
          ...
          u = function u() {
        if (i) return !1;for (var t = mt || X(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), o = 0, s = l.tweens.length; o < s; o++) {
          l.tweens[o].run(r);
        }return a.notifyWith(e, [l, r, n]), r < 1 && s ? n : (s || a.notifyWith(e, [l, 1, 0]), a.resolveWith(e, [l]), !1);
      },
          l = a.promise({ elem: e, props: ye.extend({}, t), opts: ye.extend(!0, { specialEasing: {}, easing: ye.easing._default }, n), originalProperties: t, originalOptions: n, startTime: mt || X(), duration: n.duration, tweens: [], createTween: function createTween(t, n) {
          ...
          c = l.props;for (Y(c, l.opts.specialEasing); o < s; o++) {
      ...
      function i(a) {
        var u;return o[a] = !0, ye.each(e[a] || [], function (e, a) {
          ...
          s = e === Wt;return i(t.dataTypes[0]) || !o["*"] && i("*");
    }function te(e, t) {
      var n,
          r,
      ...
      var e,
        ...
        var t, n;return !(!e || "[object Object]" !== pe.call(e)) && (!(t = se(e)) || "function" == typeof (n = de.call(t, "constructor") && t.constructor) && he.call(n) === ge);
    ...
    function (e) {
      function t(e, t, n, r) {
        var i,
          ...
          if (11 !== h && (u = ge.exec(e))) if (i = u[1]) {
            ...
            } else if (d && (s = d.getElementById(i)) && P(t, s) && s.id === i) return n.push(s), n;
          } else {
        ...
        var r = t.dir,
            ...
            o = i || r,
            s = n && "parentNode" === o,
            a = W++;return t.first ? function (t, n, i) {
          for (; t = t[r];) {
          ...
          var l,
            ...
            if (1 === t.nodeType || s) if (f = t[M] || (t[M] = {}), c = f[t.uniqueID] || (f[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t;else {
              if ((l = c[o]) && l[0] === B && l[1] === a) return p[2] = l[2];if (c[o] = p, p[2] = e(t, n, u)) return !0;
            }
          }return !1;
        };
      }function d(e) {
        ...
        return i && !i[M] && (i = m(i)), o && !o[M] && (o = m(o, s)), r(function (r, s, a, u) {
          var l,
              ...
              v = !e || !r && t ? y : g(y, p, e, a, u),
              x = n ? o || (r ? e : m || i) ? [] : s : v;if (n && n(v, x, a, u), i) for (l = g(x, d), i(l, [], a, u), c = l.length; c--;) {
            (f = l[c]) && (x[d[c]] = !(v[d[c]] = f));
          }if (r) {
            if (o || e) {
              if (o) {
          ...
          } else x = g(x === s ? x.splice(m, x.length) : x), o ? o(null, s, x, u) : G.apply(s, x);
        });
      }function y(e) {
        for (var t, n, r, i = e.length, o = w.relative[e[0].type], s = o || w.relative[" "], a = o ? 1 : 0, u = p(function (e) {
          ...
          if (n = w.relative[e[a].type]) c = [p(d(c), n)];else {
            if ((n = w.filter[e[a].type].apply(null, e[a].matches))[M]) {
              for (r = ++a; r < i && !w.relative[e[r].type]; r++) {}return m(a > 1 && d(c), a > 1 && f(e.slice(0, a - 1).concat({ value: " " === e[a - 2].type ? "*" : "" })).replace(oe, "$1"), n, a < r && y(e.slice(a, r)), r < i && y(e = e.slice(r)), r < i && f(e));
            }c.push(n);
          }
        }return d(c);
      }function v(e, n) {
        ...
        G.apply(V = J.call(R.childNodes), R.childNodes), V[R.childNodes.length].nodeType;
      } catch (e) {
        G = { apply: V.length ? function (e, t) {
            Q.apply(e, J.call(t));
          } : function (e, t) {
          ...
          n += T(t);
            ...
            var o = "nth" !== e.slice(0, 3),
              ...
              var l,
                ...
                } else if (v && (x = d = (l = (c = (f = (p = t)[M] || (p[M] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === B && l[1]), !1 === x) for (; (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++x || (v && ((c = (f = p[M] || (p[M] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [B, x]), p !== t));) {}return (x -= i) === r || x % r == 0 && x / r >= 0;
              }
            };
        ...
        var i,
          ...
          if ((o = p[0] = p[0].slice(0)).length > 2 && "ID" === (s = o[0]).type && 9 === t.nodeType && O && w.relative[o[1].type]) {
            ...
            if ((u = w.find[a]) && (r = u(s.matches[0].replace(ye, ve), me.test(o[0].type) && l(t.parentNode) || t))) {
            ...
            function o(e, t, r, i) {
              return function () {
                var a = this,
                    ...
                    l = function l() {
                  var n, l;if (!(e < s)) {
                    if ((n = r.apply(a, u)) === t.promise()) throw new TypeError("Thenable self-resolution");l = n && ("object" == (typeof n === "undefined" ? "undefined" : _typeof(n)) || "function" == typeof n) && n.then, ye.isFunction(l) ? i ? l.call(n, o(s, t, p, i), o(s, t, d, i)) : (s++, l.call(n, o(s, t, p, i), o(s, t, d, i), o(s, t, p, t.notifyWith))) : (r !== p && (a = void 0, u = [n]), (i || t.resolveWith)(a, u));
                  }
                },
                    c = i ? l : function () {
                  try {
                    ...
                    ye.Deferred.exceptionHook && ye.Deferred.exceptionHook(n, c.stackTrace), e + 1 >= s && (r !== d && (a = void 0, u = [n]), t.rejectWith(a, u));
                  }
      ...
      } }), ye.ready.then = He.then, "complete" === oe.readyState || "loading" !== oe.readyState && !oe.documentElement.doScroll ? n.setTimeout(ye.ready) : (oe.addEventListener("DOMContentLoaded", g), n.addEventListener("load", g));var Ie = function Ie(e, t, n, r, i, o, s) {
      var a = 0,
          u = e.length,
      ...
      var e = oe.createDocumentFragment().appendChild(oe.createElement("div")),
        ...
        var o,
            ...
            h,
            g,
            m = Pe.get(e);if (m) for (n.handler && (n = (o = n).handler, i = o.selector), i && ye.find.matchesSelector(Ke, i), n.guid || (n.guid = ye.guid++), (u = m.events) || (u = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
          return void 0 !== ye && ye.event.triggered !== t.type ? ye.event.dispatch.apply(e, arguments) : void 0;
        }), l = (t = (t || "").match(Le) || [""]).length; l--;) {
          d = g = (a = tt.exec(t[l]) || [])[1], h = (a[2] || "").split(".").sort(), d && (f = ye.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = ye.event.special[d] || {}, c = ye.extend({ type: d, origType: g, data: r, handler: n, guid: n.guid, selector: i, needsContext: i && ye.expr.match.needsContext.test(i), namespace: h.join(".") }, o), (p = u[d]) || ((p = u[d] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, r, h, s) || e.addEventListener && e.addEventListener(d, s)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, c) : p.push(c), ye.event.global[d] = !0);
        }
        ...
        var o,
          ...
          for (l = (t = (t || "").match(Le) || [""]).length; l--;) {
            if (a = tt.exec(t[l]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
              for (f = ye.event.special[d] || {}, p = u[d = (r ? f.delegateType : f.bindType) || d] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;) {
              ...
              }s && !p.length && (f.teardown && !1 !== f.teardown.call(e, h, m.handle) || ye.removeEvent(e, d, m.handle), delete u[d]);
            } else for (d in u) {
      ...
      ye.event.special[e] = { delegateType: t, bindType: t, handle: function handle(e) {
        ...
        var r,
            ...
            s,
            a = e.cloneNode(!0),
            u = ye.contains(e.ownerDocument, e);if (!(me.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ye.isXMLDoc(e))) for (s = T(a), r = 0, i = (o = T(e)).length; r < i; r++) {
          O(o[r], s[r]);
        }if (t) if (n) for (o = o || T(e), s = s || T(a), r = 0, i = o.length; r < i; r++) {
          L(o[r], s[r]);
        } else L(e, a);return (s = T(a, "script")).length > 0 && C(s, !u && T(e, "script")), a;
        ...
        return Ie(this, function (e) {
          var t = this[0] || {},
              n = 0,
              r = this.length;if (void 0 === e && 1 === t.nodeType) return t.innerHTML;if ("string" == typeof e && !rt.test(e) && !Ge[(Ye.exec(e) || ["", ""])[1].toLowerCase()]) {
      ...
      function e() {
        ...
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var i,
              ...
              a = ye.camelCase(t),
              u = ft.test(t),
              l = e.style;if (u || (t = R(a)), s = ye.cssHooks[t] || ye.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : l[t];"string" == (o = typeof n === "undefined" ? "undefined" : _typeof(n)) && (i = $e.exec(n)) && i[1] && (n = x(e, t, i), o = "number"), null != n && n === n && ("number" === o && (n += i && i[3] || (ye.cssNumber[a] ? "" : "px")), me.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n));
        }
      }, css: function css(e, t, n, r) {
        var i,
            o,
            s,
            a = ye.camelCase(t);return ft.test(t) || (t = R(a)), (s = ye.cssHooks[t] || ye.cssHooks[a]) && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = F(e, t, r)), "normal" === i && t in dt && (i = dt[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i;
      ...
      ye.cssHooks[t] = { get: function get(e, n, r) {
          ...
          var i,
              o = r && lt(e),
              s = r && W(e, t, r, "border-box" === ye.css(e, "boxSizing", !1, o), o);return s && (i = $e.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = ye.css(e, t)), B(0, n, s);
        } };
      ...
      ye.cssHooks[e + t] = { expand: function expand(n) {
        ...
        } }, at.test(e) || (ye.cssHooks[e + t].set = B);
        ...
        var r,
            ...
            h = e.style,
            g = e.nodeType && ze(e),
            m = Pe.get(e, "fxshow");n.queue || (null == (s = ye._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
          s.unqueued || a();
      ...
      ye.valHooks[this] = { set: function set(e, t) {
        ...
        var o,
          ...
          if (!i && !f.noBubble && !ye.isWindow(r)) {
            ...
            e.type = o > 1 ? u : f.bindType || d, (c = (Pe.get(s, "events") || {})[e.type] && Pe.get(s, "handle")) && c.apply(s, t), (c = l && s[l]) && c.apply && Fe(s) && (e.result = c.apply(s, t), !1 === e.result && e.preventDefault());
          }return e.type = d, i || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(p.pop(), t) || !Fe(r) || l && ye.isFunction(r[d]) && !ye.isWindow(r) && ((a = r[l]) && (r[l] = null), ye.event.triggered = d, r[d](), ye.event.triggered = void 0, a && (r[l] = a)), e.result;
        }
      ...
      var n,
        ...
        return this.map(function () {
          ...
          var e = this.type;return this.name && !ye(this).is(":disabled") && Lt.test(this.nodeName) && !qt.test(e) && (this.checked || !Ve.test(e));
        }).map(function (e, t) {
        ...
        function r(e, t, r, a) {
          var l,
              ...
              b,
              w,
              T = t;c || (c = !0, u && n.clearTimeout(u), i = void 0, s = a || "", C.readyState = e > 0 ? 4 : 0, l = e >= 200 && e < 300 || 304 === e, r && (b = ne(h, C, r)), b = re(h, b, C, l), l ? (h.ifModified && ((w = C.getResponseHeader("Last-Modified")) && (ye.lastModified[o] = w), (w = C.getResponseHeader("etag")) && (ye.etag[o] = w)), 204 === e || "HEAD" === h.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = b.state, p = b.data, l = !(d = b.error))) : (d = T, !e && T || (T = "error", e < 0 && (e = 0))), C.status = e, C.statusText = (t || T) + "", l ? y.resolveWith(g, [p, T, C]) : y.rejectWith(g, [C, T, d]), C.statusCode(x), x = void 0, f && m.trigger(l ? "ajaxSuccess" : "ajaxError", [C, h, l ? p : d]), v.fireWith(g, [C, T]), f && (m.trigger("ajaxComplete", [C, h]), --ye.active || ye.event.trigger("ajaxStop")));
      ...
      return ye;
    }.apply(t, r)) && (e.exports = i);var Yt = n.jQuery,
  ...
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });var r = n(8);var i = n(0),
      o = n(2),
      s = n(3),
      a = n(4),
      u = n(5),
  ...
  function n() {
    s.style.transform = "rotateY(0deg)", s.classList.remove("active"), u.style.pointerEvents = "none", a.style.pointerEvents = "auto";
  }function r() {
    s.style.transform = "rotateY(180deg)", a.style.pointerEvents = "none", u.style.pointerEvents = "auto", s.classList.add("active");
  }function i() {
    o.addEventListener("click", function (e) {
      e.preventDefault(), e.stopPropagation(), r();
    }), document.addEventListener("click", function (e) {
      !0 === s.classList.contains("active") && e.target != s && n();
      ...
      s = document.getElementById("auth-form"),
      a = document.querySelector(".welcome-form__front"),
